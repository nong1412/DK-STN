...
data_olr_1950_1978 = netCDF4.Dataset('/WdHeDisk/users/zhangnong/MJO/2023_0423_Test_DataSets/original_data/remap/rchazhi_ttr.nc')
print(data_olr_1950_1978)


#构建新数据
da = netCDF4.Dataset('/WdHeDisk/users/zhangnong/MJO/2023_0423_Test_DataSets/trans_data/olr.nc','w', format='NETCDF4')
...
olr = da.createVariable('olr','f',('time','latitude','longitude'))
olr.units = 'W m**-2'

#单位换算
u_data = np.array(data_olr_1950_1978['ttr'][:, 0, :, :])
