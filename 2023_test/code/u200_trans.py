...
data_olr_1950_1978 = netCDF4.Dataset('/WdHeDisk/users/zhangnong/MJO/2023_0423_Test_DataSets/original_data/remap/rchazhi_u200.nc')
print(data_olr_1950_1978)


#构建新数据
da = netCDF4.Dataset('/WdHeDisk/users/zhangnong/MJO/2023_0423_Test_DataSets/trans_data/u200.nc','w', format='NETCDF4')
...
u200 = da.createVariable('u200','f',('time','latitude','longitude'))
u200.units = 'm s**-1'
