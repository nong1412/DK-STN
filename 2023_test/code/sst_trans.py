...
data_olr_1950_1978 = netCDF4.Dataset('/WdHeDisk/users/zhangnong/MJO/2023_0423_Test_DataSets/original_data/remap/rchazhi_sst.nc')
print(data_olr_1950_1978)


#构建新数据
da = netCDF4.Dataset('/WdHeDisk/users/zhangnong/MJO/2023_0423_Test_DataSets/trans_data/sst.nc','w', format='NETCDF4')
...
sst = da.createVariable('sst','f',('time','latitude','longitude'))
sst.units = 'K'

#单位换算
u_data = np.array(data_olr_1950_1978['sst'][:, 0, :, :])
